 ...
 * @author yashc
 */
public class adminStudentRegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Student st = new Student(name, email, enrollment, registration, year, password);
            ...
            {
                response.sendRedirect("adminStudentRegister.jsp");
