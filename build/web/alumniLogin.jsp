<%-- 
    Document   : alumniLogin
    Created on : Apr 3, 2024, 10:23:56 AM
    Author     : yashc
--%>
...
<!--navbar content ends-->
        ...
        <!--alumni navbar ends-->
         ...
         <!--admin login strats-->
        <form method="POST" action="AlumniLoginServlet">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body primary-color">
                        ...
                        <div class="form-group text-left">
                            ...
                            <input name="alumni_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your Email">
                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                        </div>
                        <div class="form-group text-left">
                            <label for="exampleInputPassword1">Password</label>
                            <input name="alumni_password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter Your Password">
                        </div>
