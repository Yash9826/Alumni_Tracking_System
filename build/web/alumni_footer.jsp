<!--footer starts-->
        <footer style="background-color: black" class="mt-4">
            <div class="container primary-color " style="color: white">
                <div class="row py-5 py-lg-5">
                    ...
                    <div class="col-4 text-left">
                        ...
                        <span class=" fa fa-arrow-right"><a href="" >&nbsp;Home</a></span></br>
                        <span class="fa fa-arrow-right"><a href="" >&nbsp;About Us</a></span></br>
                        <span class="fa fa-arrow-right"><a href="" >&nbsp;Events</a></span></br>
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-12">
                        <a href="alumniLogin.jsp"  ><h5 style="display:inline; color: white">|&emsp;&emsp;</h5>Alumni Login</a><h5 style="display:inline; color: white"> &emsp;&emsp;|&emsp;&emsp;</h5>
