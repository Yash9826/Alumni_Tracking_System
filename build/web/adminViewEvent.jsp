<%-- 
    Document   : adminViewEvent
    Created on : Feb 29, 2024, 3:25:12 PM
    Author     : yashc
--%>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><td><img src="pic/<%= event1.getEimage() %>" width="300px" height="200px" alt="Source not found"/></td>
                                <td><a href="adminGetEventById.jsp?id=<%= event1.getEid()%>"  > <button  type="submit" class="submit-btn btn btn-outline-success">Edit</button></a></td>
