<%-- 
    Document   : adminVerfiyAlumni
    Created on : Mar 25, 2024, 4:44:20 PM
    Author     : yashc
--%>
...
<html>
    ...
    <body>
        ...
        <!--verify alumni modal starts-->
        <!-- Button trigger modal -->
        <div class="container text-center mx-6 mt-5 md-5">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                Click Here, To Verify Alumni
            </button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="adminVerifyAlumniServlet">
